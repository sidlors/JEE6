package mx.com.sidlors.commons.utils;
 ...
 */
public final class JEEUtils implements Serializable
{
  
  private static final Logger LOG = Logger.getLogger( JEEUtils.class );
