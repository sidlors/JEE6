...
import mx.com.sidlors.commons.utils.JEEUtils;
...
public abstract class AbstractSignedEntity<T> extends AbstractEntity<T>
{
  ...
  {
    return JEEUtils.enhancedClone( dtLastModification );
  }
  ...
  {
    this.dtLastModification = JEEUtils.enhancedClone( dtLastModification );
  }
